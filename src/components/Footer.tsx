      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="font-mono text-xs text-muted-foreground tracking-wider">// BUILT FOR THOSE WHO<br />// RIDE BEYOND</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 font-body text-muted-foreground text-sm">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Group Rides</a></li>
            </ul>
          </div>
