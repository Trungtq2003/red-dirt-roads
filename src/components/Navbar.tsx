            ...
            {dropdownOpen && (
              <div className="absolute top-full left-0 mt-2 min-w-[180px] bg-card border border-border shadow-lg z-50">
                <a
                  ...
                  className="block px-5 py-3 font-heading text-sm uppercase tracking-wider text-foreground hover:text-primary hover:bg-muted/50 transition-colors"
                >
                  🏍️ {t.nav.dirtbikes}
                </a>
                <a
                  href="#tours"
                  onClick={() => setDropdownOpen(false)}
                  className="block px-5 py-3 font-heading text-sm uppercase tracking-wider text-foreground hover:text-primary hover:bg-muted/50 transition-colors border-t border-border"
                >
                  🔥 {t.nav.bigBikes}
                </a>
              </div>
      ...
      {open && (
        <div className="md:hidden bg-surface border-b border-border">
          <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
            {/* Mobile Motorbike Tours Dropdown */}
            <div>
              <button
